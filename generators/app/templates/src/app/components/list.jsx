...
export default class Home extends React.Component {
    constructor(props) {
        ...
        this.changeAjaxCallback = this.ajaxStateChanged.bind(this);
        ...
        return (
            <div className={ style. main }>
                <div className={ style.first }>
                    ...
                    <input onChange={ this.onChangeStoreInput.bind(this)} value={ this.state.inputStoreValue } type="text" placeholder="value..."/>
                ...
                <div className={ style.second }>
                    ...
                    <input onChange={ this.onChangeAjaxInput.bind(this)} value={ this.state.inputAjaxValue } type="text" placeholder="http://..."/>
